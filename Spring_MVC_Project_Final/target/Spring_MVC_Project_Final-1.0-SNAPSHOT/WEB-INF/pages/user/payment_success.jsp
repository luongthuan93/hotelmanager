                ...
                <div class="row">
                    <div class="col-md-12 mb-12 ms-12">
                        <div class="block-3 d-md-flex">
                            <div class="image" style="background-image: url('<c:url value="/resources/images/img_2.jpg"/>');"></div>
                            <div class="text">
                                <h2 class="heading">Successful Booking!!!</h2>
                                <ul class="specs mb-5">
                                    <li>
                                ...
                                <button onclick="location.href = '<c:url value="/user/home"/>'"
