				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Room Type Management</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li><a class="parent-item" href="">RoomType</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								...
								<div class="card-body ">
									...
									<div class="table-scrollable">
										<table class="table table-hover table-checkable order-column full-width" id="example4">
											...
											<tbody>
                                                                                            <c:forEach items="${roomTypes}" var="rt" varStatus="status">
												<tr class="odd gradeX">
													
													<td class="center">${status.count}</td>
													<td class="center">${rt.name}</td>
													<td class="center text-truncate" style="max-width: 80px;">${rt.description}</td>
													<td class="center">${rt.price} USD</td>
													<td class="center">${rt.size} &#13217;</td>
													<td class="center">${rt.numberOfBed}</td>
													<td class="center">${rt.status}</td>
													<td class="center">
														<a href="${pageContext.request.contextPath}/admin/edit-roomtype/${rt.id}" class="btn btn-tbl-edit btn-xs">
