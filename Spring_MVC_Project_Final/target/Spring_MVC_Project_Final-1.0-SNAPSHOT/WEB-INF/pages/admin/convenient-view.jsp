				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Convenient Management</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li><a class="parent-item" href="">Convenient</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li class="active">All Convenient</li>
							</ol>
						</div>
					</div>
					<div class="row">
								...
								<div class="card-body ">
									<div class="row p-b-20">
										<div class="col-md-6 col-sm-6 col-6">
											<div class="btn-group">
												<a href="${pageContext.request.contextPath}/admin/add-convenient" id="addRow" class="btn btn-info">
									...
									<div class="table-scrollable">
										<table class="table table-hover table-checkable order-column full-width" id="example4">
											...
											<tbody>
                                                                                        <c:forEach items="${convenients}" var="c" varStatus="status">
												...
												<tr class="odd gradeX">
													...
													<td class="center text-truncate" style="max-width: 100px;">${c.description}</td>
													<td class="center">${c.status}</td>
													
													<td class="center">
														<a href="${pageContext.request.contextPath}/admin/edit-convenient/${c.id}" class="btn btn-tbl-edit btn-xs">
