										...
										<table class="table table-hover table-checkable order-column full-width" id="example4">
											<thead>
												<tr>
													...
													<th class="center"> openTime </th>
													<th class="center"> closeTime </th>
											...
											<tbody>
												...
												<tr class="odd gradeX">
													...
													<td class="center"><fmt:formatNumber value = "${s.amount}" type = "currency"/></td>
													<td class="center text-truncate" style="max-width: 50px;">${s.description}</td>
													<td class="center">${s.position}</td>
													<td class="center">${s.openTime}</td>
													<td class="center">${s.closeTime}</td>
													<td class="center">${s.status}</td>
													<td class="center">
														<a href="${pageContext.request.contextPath}/admin/edit-service/${s.id}" class="btn btn-tbl-edit btn-xs">
